...
<html lang="en">
  ...
  <head>
    ...
    <link href="sources/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href='https://fonts.googleapis.com/css?family=Lora:400,700,400italic,700italic' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>

    <!-- Custom styles for this template -->
    <link href="sources/bootstrap/css/clean-blog.min.css" rel="stylesheet">
              ...
              <form action="traitement_inscription.php" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-18 col-md-12 ">
                    ...
                    <br>
                    <input type="text" class="form-control" name="adresseL1Resp" placeholder="Adresse *" required="true">
                    <br>
                    <input type="text" class="form-control" name="adresseL2Resp" placeholder="Adresse ligne 2">
                    <br>
                    <input type="text" class="form-control" name="telephoneResp" placeholder="Telephone (05.--.--.--.--)">
                    <br>
                    <input type="text" class="form-control" name="mailResp" placeholder="Mail *" required="true">
                    <br>
                    <input type="text" class="form-control" name="cpResp" placeholder="Code postal *" required="true">
                    <br>
               ...
               <br>
               <input type="submit" value="Valider" class="btn btn-primary validation" onmouseover="this.style.cursor='pointer'" />
              </form>
          </div>
        </div>
      </div>
